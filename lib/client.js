	...
	factory: (require) => {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								...
								children: editing ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("svg", {
									...
									"aria-hidden": "true",
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
										d: "M11.4 2.6a1.6 1.6 0 0 1 2 2L5.6 12.4l-3.1 1.1 1.1-3.1L11.4 2.6Z",
										stroke: "currentColor",
										strokeWidth: "1.2",
										strokeLinejoin: "round"
		...
		*/
		function ManagerModal(props) {
			...
			const addPrompt = (categoryId) => {
				setStaged((prev) => ({
					...prev,
					prompts: [...prev.prompts, newPrompt(categoryId)]
				}));
				setNotice(null);
			};
			const addCategory = () => {
			...
			const removeCategory = (id) => {
				setStaged((prev) => ({
					...
					prompts: prev.prompts.map((p) => p.categoryId === id ? {
						...p,
						categoryId: ""
					} : p)
				}));
		...
		*/
		const zh = {
			...
			"preview.title": "指令预览",
			"preview.label": "名称",
			"preview.textHint": "默认只读，点击 ✎ 编辑全文；{{占位符}} 会在同步/发送时替换为下方填写的值",
			"preview.edit": "编辑",
			"preview.done": "完成编辑",
		...
		const en = {
			...
			"preview.label": "Name",
			"preview.textHint": "Read-only by default — click ✎ to edit; {{placeholders}} are replaced with the values below on sync/send",
			"preview.edit": "Edit",
