window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		function groupByFeature(items, uncategorizedLabel) {
			const groups = [];
		...
		*/
		function ManagerModal(props) {
			...
			const doExport = () => {
				const payload = items.map(({ label, text, category }) => ({
					label,
					text,
					...category !== void 0 && category.trim() !== "" ? { category: category.trim() } : {}
				}));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
				...
				children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					role: "dialog",
					"aria-modal": "true",
					style: { width: "min(660px, calc(100vw - 48px))" },
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: {
								display: "flex",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								groups.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
									className: quick_prompts_module_css_default.hint,
									style: {
										padding: "12px 0",
										textAlign: "center"
									...
									children: groups.map((group) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										className: quick_prompts_module_css_default.group,
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												className: quick_prompts_module_css_default.groupHeader,
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: quick_prompts_module_css_default.groupName,
														children: group.name
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														className: quick_prompts_module_css_default.groupCount,
											...
											group.items.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												className: quick_prompts_module_css_default.hint,
												style: { padding: "4px 0 8px" },
												children: t("manager.groupEmpty")
											}) : null
										]
									}, group.key === "" ? "__uncat__" : group.key))
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("datalist", {
									id: "quick-prompts-categories",
									children: knownCategories.map((category) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", { value: category }, category))
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
		...
		*/
		const zh = {
			...
			"manager.categoryField": "所属功能",
			"manager.categoryPlaceholder": "选择或输入新功能名",
			"manager.addCategory": "添加功能",
		...
		const en = {
			...
			"manager.categoryField": "Feature",
			"manager.categoryPlaceholder": "Pick or type a new feature name",
