	...
	factory: (require) => {
		...
		*/
		function ManagerModal(props) {
			...
			const editorBackRef = (0, react.useRef)(null);
		...
		*/
		...
		function writeStoredFeature(id, value) {
			try {
		...
		*/
		...
		const QuickPromptsDock = (0, react.memo)(function QuickPromptsDock(props) {
			...
			const [feature, setFeature] = (0, react.useState)(() => readStoredFeature(session.sessionId));
