	...
	factory: (require) => {
		...
		*/
		function ManagerModal(props) {
			...
			const [editingTextId, setEditingTextId] = (0, react.useState)(null);
									...
									children: selectedPrompts.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										children: selectedPrompts.map((item) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
												...
												children: [editingTextId === item.id ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
													className: quick_prompts_module_css_default.textarea,
													style: { minHeight: 56 },
													value: item.text,
													...
													spellCheck: false,
													autoFocus: true
												}) : item.text !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("pre", {
													...
													children: editingTextId === item.id ? ICONS.done : ICONS.rename
												})]
											})]
										}, item.id))
									})
